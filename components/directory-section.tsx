      ...
      <div ref={ref} className="mx-auto max-w-7xl px-6">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {filtered.map((person, i) => (
            <div
              key={person.name}
              className="group overflow-hidden rounded-2xl border border-border bg-background p-6 shadow-sm transition-all duration-300 hover:shadow-lg hover:-translate-y-1 hover:border-primary/20"
            >
              <div className="mb-4 flex items-center gap-4">
                <div className={`flex h-12 w-12 items-center justify-center rounded-full ${avatarColors[i % avatarColors.length]} text-sm font-bold text-primary-foreground`}>
                  {person.avatar}
                </div>
              ...
              <div className="mb-4 flex flex-col gap-2">
                ...
                <div className="flex items-center gap-2 text-xs text-muted-foreground">
                  ...
                  {person.dept} &middot; Class of {person.year}
                </div>
              </div>
